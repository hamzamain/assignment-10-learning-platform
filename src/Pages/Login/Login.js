  ...
  return (
    <div>
      <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 border  my-5 mx-auto">
        ...
        <p className="text-sm text-center dark:dark:dark:text-gray-400">
          Dont have account?
          <Link
            to={"/register"}
        ...
        <div className="flex items-center w-full my-4">
          ...
          <p className="px-3 dark:dark:dark:text-gray-400">OR</p>
          <hr className="w-full dark:dark:dark:text-gray-400" />
        </div>
        <form
          novalidate=""
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="text-xs hover:underline dark:dark:dark:text-gray-400"
                >
                  Forgot password?
                </a>
              </div>
