                ...
                <form className="space-y-3">
                  <div className="flex shadow-sm rounded">
                    ...
                    <div className="flex-none w-[4.8rem]">
                      <input
                        name="card-expiry"
                        className="text-sm text-gray-800 bg-white leading-5 py-2 px-3 placeholder-gray-400 w-full border border-transparent focus:border-indigo-300 focus:ring-0"
                        type="text"
                        placeholder="MM/YY"
                    ...
                    <div className="flex-none w-[3.5rem]">
                      <input
                        name="card-cvc"
                        className="text-sm text-gray-800 bg-white rounded-r leading-5 py-2 px-3 placeholder-gray-400 w-full border border-transparent focus:border-indigo-300 focus:ring-0"
                        type="text"
                        placeholder="CVC"
                        aria-label="CVC"
                      />
